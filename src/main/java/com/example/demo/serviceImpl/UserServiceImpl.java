...
public class UserServiceImpl implements UserService {
    ...
    private boolean validateSignUpMap(Map<String, String> requestMap) {
        ...
        if (requestMap.containsKey("idUsuario") && requestMap.containsKey("nombreCompleto") &&
    ...
    private Usuario getUserFromMap(Map<String, String> requestMap) {
        ...
        try {
            usuario.setIdUsuario(Long.parseLong(requestMap.get("idUsuario")));
        } catch (NumberFormatException e) {
            throw new IllegalArgumentException("idUsuario debe ser un número válido.");
        }
